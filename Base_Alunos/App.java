...
public class App {
    ...
    /**
     * Localiza um produto no vetor de produtos cadastrados, a partir do código
     * informado.
     */
    ...
    /**
     * Localiza um produto no vetor de produtos cadastrados, a partir da descrição
     * informada.
     */
    ...
    public static void finalizarPedido(Pedido pedido) {
        if (pedido != null && !pedido.getItensDoPedido().vazia()) {
            ...
            cabecalho();
            System.out.println("Pedido inválido ou sem itens!");
        }
    }
    ...
    public static void filtrarPorProduto() {
        ...
        System.out.println("Lista de itens filtrados de acordo com a descrição passada \n");
